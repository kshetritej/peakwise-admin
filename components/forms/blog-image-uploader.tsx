...
import { LucideImages, LucideUpload, X } from "lucide-react";
import Image from "next/image";
import { uploadMultipleImagesToLocal } from "@/app/actions/uploadImageToCloudflare";
...
const ImageUploader = ({
  ...
  const handleUpload = async (file: File) => {
    ...
    try {
      ...
      const imageUrl = await uploadMultipleImagesToLocal([file], "blogCovers");
      setImg(imageUrl);
    ...
    <div className="flex flex-col gap-2">
      ...
      <div className="flex items-center gap-2">
        <Button
          ...
          disabled={loading}
        >
          {loading ? "..." : <LucideImages className="h-6 w-6" />}
        </Button>
