          ...
          <div className="flex flex-col items-center gap-2 text-center">
            ...
            {process.env.NEXT_PUBLIC_IS_GROWFORE == "true" && (
              <>
                ...
                <div className="p-2 bg-primary/40 rounded-md text-sm">
                  <div
                    onClick={() => {
                  ...
                  <div
                    onClick={() => {
                      window.navigator.clipboard.writeText("GetMyAccess@2026");
                      toast.success("Copied to clipboard.");
                    }}
                    className="flex gap-4 items-center"
                  >
                    Password : GetMyAccess@2026
                    <Button size={"icon-xs"} variant={"ghost"} type="button">
                      <LucideCopy className="size-4" />
                    </Button>
                  </div>
