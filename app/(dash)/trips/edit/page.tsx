  ...
  return (
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
      ...
      <div className={cn(currStep === 2 ? "flex flex-col gap-3" : "hidden")}>
        ...
        <div className="grid grid-cols-2  gap-2">
          ...
          <div>
            ...
            <LabelDescription text="The type of accommodation travelers can expect during the trip. Seperated by Comma." />
            <Input
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="Eg. Stay in a Local Homstay"
                />
              </div>
            </div>
      ...
      <div className={cn(currStep === 5 ? "flex flex-col gap-3" : "hidden")}>
        ...
        <div className="flex flex-col gap-2">
          <Label htmlFor="dropOffPoint">Dropoff Point / End</Label>
